...
export default function SedayFooter() {
  return (
    <footer className="bg-sd-bg border-t border-sd-outline/20 font-sd">
      <div className="max-w-6xl mx-auto px-6 py-12 grid gap-10 md:grid-cols-3 text-left">
      ...
      <div className="border-t border-sd-outline/20">
        <p className="max-w-6xl mx-auto px-6 py-4 text-left text-sd-onSurfaceVariant text-xs">
