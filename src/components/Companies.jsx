  ...
  return (
    <section id="empresas" className="section-shell reveal">
      <div className="section-heading">
        <span className="eyebrow">Empresas do grupo</span>
      </div>
      <div className="card-grid">
        ...
        <article className="company-card company-card--seday">
          <img className="company-logo" src="/img/logos/logo-seday-equipamentos-compacto.svg" alt="Logo Seday Equipamentos" />
